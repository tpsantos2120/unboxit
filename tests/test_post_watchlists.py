...
class TestPostWatchlist(BaseCase):
    ...
    def test_post_watchlists_successful(self):
        ...
        payload_entry = json.dumps({
            ...
            + "hope and hardships drive humanity to look to the"
            + "stars and beyond. While a mysterious phenomenon menaces"
            + "to destroy life on planet Earth, astronaut Roy McBride"
            + "undertakes a mission across the immensity of space and"
            + "its many perils to uncover the truth about a lost expedition"
            + "that decades before boldly faced emptiness and silence"
